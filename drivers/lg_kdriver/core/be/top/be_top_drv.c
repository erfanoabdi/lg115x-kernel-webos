...
----------------------------------------------------------------------------------------*/
const char be_drv_ver[] = BE_DRV_VER;
const char be_led_drv_ver[] = BE_LED_VER;
const char be_h3d_drv_ver[] = BE_H3D_VER;
const char be_pwm_drv_ver[] = BE_PWM_VER;
const char be_top_drv_ver[] = BE_TOP_VER;
const char be_fwi_drv_ver[] = BE_FWI_VER;
const char be_reg_drv_ver[] = BE_REG_VER;

const char be_chip_h13_ver[] = BE_CHIP_H13_VER;
const char be_chip_h14_ver[] = BE_CHIP_H14_VER;
const char be_chip_m14_ver[] = BE_CHIP_M14_VER;


/* For DE */
const char de_drv_ver[] = DE_DRV_VER;

const char de_chip_h13_ver[] = DE_CHIP_H13_VER;
const char de_chip_h14_ver[] = DE_CHIP_H14_VER;
const char de_chip_m14_ver[] = DE_CHIP_M14_VER;

/* For AFE */
const char afe_drv_ver[] = AFE_DRV_VER;

const char afe_chip_h13_ver[] = AFE_CHIP_H13_VER;
const char afe_chip_h14_ver[] = AFE_CHIP_H14_VER;
const char afe_chip_m14_ver[] = AFE_CHIP_M14_VER;
...
int BE_TOP_Ioctl(unsigned int cmd, unsigned long arg)
{
	...
	switch(cmd)
	{
		...
		{
			printk("--------------------------------\n");
			printk("|  GIT DATE INFO on BE MODULE  |\n");
			printk("--------------------------------\n");
			printk("[GIT INFO] kdriver/core/be     => %s\n",be_drv_ver);
			printk("[GIT INFO] kdriver/core/be/led => %s\n",be_led_drv_ver);
			printk("[GIT INFO] kdriver/core/be/h3d => %s\n",be_h3d_drv_ver);
			printk("[GIT INFO] kdriver/core/be/pwm => %s\n",be_pwm_drv_ver);
			printk("[GIT INFO] kdriver/core/be/top => %s\n",be_top_drv_ver);
			printk("[GIT INFO] kdriver/core/be/fwi => %s\n",be_fwi_drv_ver);
			printk("[GIT INFO] kdriver/core/be/reg => %s\n",be_reg_drv_ver);
			printk("[GIT INFO] kdriver/chip/h13/be => %s\n",be_chip_h13_ver);
			printk("[GIT INFO] kdriver/chip/h14/be => %s\n",be_chip_h14_ver);
			printk("[GIT INFO] kdriver/chip/m14/be => %s\n",be_chip_m14_ver);
			printk("\n");
			printk("--------------------------------\n");
			printk("|  GIT DATE INFO on DE MODULE  |\n");
			printk("--------------------------------\n");		
			printk("[GIT INFO] kdriver/core/de     => %s\n",de_drv_ver);
			printk("[GIT INFO] kdriver/chip/h13/de => %s\n",de_chip_h13_ver);
			printk("[GIT INFO] kdriver/chip/h14/de => %s\n",de_chip_h14_ver);
			printk("[GIT INFO] kdriver/chip/m14/de => %s\n",de_chip_m14_ver);
			printk("\n");
			printk("--------------------------------\n");
			printk("|  GIT DATE INFO on AFE MODULE  |\n");
			printk("--------------------------------\n");		
			printk("[GIT INFO] kdriver/core/afe     => %s\n",afe_drv_ver);
			printk("[GIT INFO] kdriver/chip/h13/afe => %s\n",afe_chip_h13_ver);
			printk("[GIT INFO] kdriver/chip/h14/afe => %s\n",afe_chip_h14_ver);
			printk("[GIT INFO] kdriver/chip/m14/afe => %s\n",afe_chip_m14_ver);
