...
----------------------------------------------------------------------------------------*/
/* For OVI */
const char ovi_drv_ver[] = OVI_DRV_VER;

const char ovi_chip_h13_ver[] = OVI_CHIP_H13_VER;
const char ovi_chip_h14_ver[] = OVI_CHIP_H14_VER;
const char ovi_chip_m14_ver[] = OVI_CHIP_M14_VER;
...
int OVI_HAL_GetDateInfo(void)
{
	...
	printk("\n--------------------------------\n");
	printk("|  GIT DATE INFO on OVI MODULE  |\n");
	printk("--------------------------------\n");
	printk("[GIT INFO] kdriver/core/ovi	     => %s\n",ovi_drv_ver);
	printk("[GIT INFO] kdriver/chip/h13/ovi     => %s\n",ovi_chip_h13_ver);
	printk("[GIT INFO] kdriver/chip/h14/ovi     => %s\n",ovi_chip_h14_ver);
	printk("[GIT INFO] kdriver/chip/m14/ovi     => %s\n",ovi_chip_m14_ver);
