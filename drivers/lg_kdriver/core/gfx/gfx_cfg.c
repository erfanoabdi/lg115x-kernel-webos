...
LX_GFX_REG_CFG_T	gfx_reg_cfg_desc_table[] =
{
	...
	/* M14Ax*/[2] = { .chip = LX_CHIP_M14, .chip_name = "GFX-M14Ax",.reg_base_addr = 0xc000b000, .reg_size = 0x200, .irq_num = (32+54) },
	/* M14Bx*/[3] = { .chip = LX_CHIP_M14, .chip_name = "GFX-M14Bx",.reg_base_addr = 0xc000b000, .reg_size = 0x200, .irq_num = (32+56) },
