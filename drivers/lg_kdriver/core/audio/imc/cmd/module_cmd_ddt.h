...
#define DDT_CMD_SET_PARAM       ADEC_CMD(0x2000, DdtCmdSetParam)

#define DDT_CMD_DESTROY_LIB     ADEC_CMD_SIMP(0x2010)
#define DDT_CMD_DEBUG_STATUS    ADEC_CMD_SIMP(0x2020)
