...
#ifndef _SDEC_REG_M14A0_H_
#define _SDEC_REG_M14A0_H_
...
typedef struct {
	...
	UINT32								sdmwc_sw_reset;					// 0x0060
	UINT32								sdmwc_stat;						// 0x0064
	UINT32                          	                 __rsvd_01[   2];	// 0x0068 ~ 0x006c
	...
	UINT32                         		gstc0[ 3]                       ;	// 0x00c0 ~ 0x00c8
	UINT32                          	                 __rsvd_05[   1];	// 0x00cc
	STCC_G_TIMER						stcc_g_timer[2]                 ;	// 0x00d0 ~ 0x00dc
	UINT32                         		gstc1[ 3]                       ;	// 0x00e0 ~ 0x00e8
	UINT32                          	                 __rsvd_06[   5];	// 0x00ec ~ 0x00fc
	INTR_EN                         	intr_en                         ;	// 0x0100 : ''
	UINT32                       		intr_stat                       ;	// 0x0104 : ''
	INTR_RSTAT                      	intr_rstat                      ;	// 0x0108 : ''
	UINT32                          	                 __rsvd_07[   1];	// 0x010c
