...
typedef struct {
	UINT32
	reg_vdec0_addr_de_sav           ;   	// 31: 0
} VDEC0_AXI_ADDR_SW_CONF0;

/*-----------------------------------------------------------------------------
	0x0064 vdec0_axi_addr_sw_conf1 ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32
	reg_vdec0_addr_cpu_gpu          ;   	// 31: 0
} VDEC0_AXI_ADDR_SW_CONF1;

/*-----------------------------------------------------------------------------
	0x0068 vdec0_axi_addr_sw_conf2 ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32
	reg_vdec0_addr_cpu_shadow       ;   	// 31: 0
} VDEC0_AXI_ADDR_SW_CONF2;

/*-----------------------------------------------------------------------------
	0x0070 vdec1_axi_addr_sw_conf0 ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32
	reg_vdec1_addr_de_sav           ;   	// 31: 0
} VDEC1_AXI_ADDR_SW_CONF0;

/*-----------------------------------------------------------------------------
	0x0074 vdec1_axi_addr_sw_conf1 ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32
	reg_vdec1_addr_cpu_gpu          ;   	// 31: 0
} VDEC1_AXI_ADDR_SW_CONF1;

/*-----------------------------------------------------------------------------
	0x0078 vdec1_axi_addr_sw_conf2 ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32
	reg_vdec1_addr_cpu_shadow       ;   	// 31: 0
} VDEC1_AXI_ADDR_SW_CONF2;
...
typedef struct {
	...
	UINT32         	vdec0_axi_addr_sw_conf0         ;	// 0x0060 : ''
	UINT32         	vdec0_axi_addr_sw_conf1         ;	// 0x0064 : ''
	UINT32         	vdec0_axi_addr_sw_conf2         ;	// 0x0068 : ''
	UINT32                          	                 __rsvd_03[   1];	// 0x006c
	UINT32         	vdec1_axi_addr_sw_conf0         ;	// 0x0070 : ''
	UINT32         	vdec1_axi_addr_sw_conf1         ;	// 0x0074 : ''
	UINT32         	vdec1_axi_addr_sw_conf2         ;	// 0x0078 : ''
} RC1_REG_T;
/* 21 regs, 21 types */
