...
DTV_STATUS_T SDEC_SWP_EnableSWParser(S_SDEC_PARAM_T *stpSdecParam,	 LX_SDEC_SECFLT_ENABLE_SWPARSER_T *stpLXSdecSecfltEnableSWParser);
...
DTV_STATUS_T SDEC_RFOUT_Enable(S_SDEC_PARAM_T *stpSdecParam, LX_SDEC_RFOUT_ENABLE_T *stpLXSdecRFOUTEnable);
