...
typedef enum {
	...
	VDU_FRM_MAP_TILED_HEVC		= 3,
	VDU_FRM_MAP_TILED_HEVC10	= 4,
	VDU_FRM_MAP_TILED_8X4		= 5, /* g1 */
	VDU_FRM_MAP_TILED_4X4		= 6, /* g2 */

	VDU_FRM_MAP_MIN				= VDU_FRM_MAP_LINEAR,
	VDU_FRM_MAX					= VDU_FRM_MAP_TILED_4X4,
	VDU_FRM_INVALID
} VDU_FRM_MAP_T;
...
typedef enum {
	VDU_LINEAR_MODE_NONE		= 0,
	VDU_LINEAR_MODE_STATIC		= 1,
	VDU_LINEAR_MODE_DYNAMIC		= 2,

	VDU_LINEAR_MODE_MIN			= VDU_LINEAR_MODE_NONE,
