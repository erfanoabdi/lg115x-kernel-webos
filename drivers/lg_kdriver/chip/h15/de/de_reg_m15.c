...
LX_DE_DISPLAY_DEVICE_T	g_Display_type_M14 = LX_DE_DIS_DEV_LCD;
LX_DE_DISPLAY_MIRROR_T	g_Display_mirror_M14 = LX_DE_DIS_MIRROR_OFF;
LX_DE_PANEL_TYPE_T 		g_Display_size_M14 = LX_PANEL_TYPE_1920;
...
//	intr-clear in mcu side				DE_DEI_M14B_WrFL(intr_reg);
...
int DE_REG_M14_SetVTM(LX_DE_VTM_FRAME_INFO_T *pstParams)
{
	...
	do {
		...
		if ( lx_chip_rev() >= LX_CHIP_REV(M14,B0) ) {
			...
			pstParams->address = VIDEO_M14_FIRMWARE_MEM_BASE_WEB_OS;
		}
	...
	switch(mcu_id)
	{
		case 0:
			if ( lx_chip_rev() >= LX_CHIP_REV(M14,B0) ) {
				...
				DE_DEI_M14B_Wr01(mem3_sync_period, mem_sync_period, 0x64B540);/* 30Hz */
	...
	do {
		...
		switch (pstParams->operation) {
			case LX_DE_SUB_OPER_OFF :
				g_SrcSubOperType_M14 = LX_DE_SUB_OPER_OFF;
				break;
			case LX_DE_SUB_OPER_CAPTURE:
				g_SrcSubOperType_M14 = LX_DE_SUB_OPER_CAPTURE;
				flag = pstParams->capture_enable;
				break;
			case LX_DE_SUB_OPER_VENC:
				g_SrcSubOperType_M14 = LX_DE_SUB_OPER_VENC;
				flag = pstParams->vencCtrl.bOnOff;
				break;
			case LX_DE_SUB_OPER_SCART_OUT:
				g_SrcSubOperType_M14 = LX_DE_SUB_OPER_SCART_OUT;
				flag = 1;
				break;
