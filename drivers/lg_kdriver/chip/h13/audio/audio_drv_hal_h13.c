...
#ifdef USE_H13_AUDIO_DSP_FIRMWARE
#ifndef IC_CERTIFICATION
#include "firmware/multi_codec_h13.h"			// audio decoder & encoder for DSP0
#else
#include "firmware/multi_codec_h13_certi.h"		// audio decoder & encoder for DSP0
#endif
#include "firmware/multi_se_codec_h13.h" 		// audio post processing & se(sound engine) codec for DSP1
#endif	//#ifdef USE_H13_AUDIO_DSP_FIRMWARE
...
#ifdef NOT_MEMMORY_OPTIMIZE
	AUD_H13_Wr(aud_dsp0offset5, pstMemCfgAud->fw0_memory_base);
...
#ifdef NOT_MEMMORY_OPTIMIZE
	AUD_H13_Wr(aud_dsp1offset5, pstMemCfgAud->fw1_memory_base);
...
SINT32 H13_AUDIO_CopyDSP1Codec ( void )
{
...
#endif
	AUD_KDRV_DEBUG("H13_AUDIO_CopyDSP1Codec : Started... Codec(%s), Size(%d)\n", codecName, ui32CodecSize);
	...
	if(g_AudKdrv.CopyDSP1 == TRUE)
	{
		...
		AUD_KDRV_PRINT("H13_AUDIO_CopyDSP1Codec : Done(%s)!!!\n", codecName );
	}

	AUD_KDRV_DEBUG_TMP("H13_AUDIO_CopyDSP1Codec : Done(%s)!!!\n", codecName);
	return RET_OK;
#else
	AUD_KDRV_ERROR("H13_AUDIO_CopyDSP1Codec : DSP1 Firmware is not linked!!!\n");
	return RET_OK;
#endif	//#ifdef USE_H13_AUDIO_DSP_FIRMWARE
}
...
SINT32 H13_AUDIO_CopyDSP0Codec ( void )
{
	...
	{
		AUD_KDRV_ERROR("H13_AUDIO_CopyDSP0Codec : %s size is bigger than memory.(%d > %d)\n",	\
...
#endif
	AUD_KDRV_DEBUG("H13_AUDIO_CopyDSP0Codec : Started... Codec(%s), Size(%d)\n", codecName, ui32CodecSize);
	...
	if(g_AudKdrv.CopyDSP0 == TRUE)
	{
		...
		AUD_KDRV_PRINT("H13_AUDIO_CopyDSP0Codec : Done(%s)!!!\n", codecName );
	}

	AUD_KDRV_DEBUG_TMP("H13_AUDIO_CopyDSP0Codec : Done(%s)!!!\n", codecName);
	return RET_OK;
#else
	AUD_KDRV_ERROR("H13_AUDIO_CopyDSP0Codec : DSP0 Firmware is not linked!!!\n");
	return RET_OK;
#endif	//#ifdef USE_H13_AUDIO_DSP_FIRMWARE
}
