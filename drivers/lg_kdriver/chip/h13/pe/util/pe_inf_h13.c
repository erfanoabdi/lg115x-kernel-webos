...
#define PE_INF_H13_DRV_VER		"2014/05/26/10:00"
		...
		if(PE_KDRV_VER_H13)
		{
			...
			if(_g_pe_inf_h13_trace)
			{
				if(count>PE_PRINT_COUNT_NUM)
				{
					...
					PE_INF_H13_DBG_PRINT("disp[0] : in_win:%d,%d,%d,%d,out_win:%d,%d,%d,%d\n", \
					...
					PE_INF_H13_DBG_PRINT("disp[1] : in_win:%d,%d,%d,%d,out_win:%d,%d,%d,%d\n", \
