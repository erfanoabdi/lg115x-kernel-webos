...
UINT16 _gM14B0GBB_FullDVBPkerrThreshold = 170;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_DVBC_Set_QamMode (UINT8 constel)
{
	...
	else
	{
		...
		else
		{
			...
			if(pDemodInfo->unLockLongCount == 20)
			{
				...
				DEMOD_PRINT( "^R^[DEMOD M14 GBB] LX_DEMOD_SYNC_CHECKING : Going to LX_DEMOD_RETUNE_RF..... ^0^\n");
