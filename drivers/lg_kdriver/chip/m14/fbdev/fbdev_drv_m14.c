...
----------------------------------------------------------------------------------------*/
extern void FBDEV_M14_EventCallback		(FBDEV_HW_EVENT_T ev, FBDEV_HW_EVENT_DATA_T* data );
...
static	FBDEV_HW_CTX_T		g_fbdev_hw_ctx_m14 =
{
	...
	.EventCallback		= FBDEV_M14_EventCallback,
};
...
========================================================================================*/
void FBDEV_M14_EventCallback		(FBDEV_HW_EVENT_T ev, FBDEV_HW_EVENT_DATA_T* data )
{
	switch(ev)
	{
