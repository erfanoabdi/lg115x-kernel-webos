...
#include "../../chip/m14/de/ctop_ctrl_reg_m14.h"
...
#ifdef INCLUDE_KDRV_DE
extern volatile CTOP_CTRL_REG_M14_T gDE_CTOP_M14;
#endif
#endif
...
int DENC_REG_M14_Init(void)
{
	...
	do {
		if(lx_chip_rev() >= LX_CHIP_REV(M14,B0))
		{
			...
			CTOP_CTRL_M14B0_Wr01(DEO, ctr01, swrst_cve27, 0x0);
...
#ifdef INCLUDE_KDRV_SYS
#ifdef INCLUDE_KDRV_DE
			CTOP_CTRL_M14_RdFL(ctr27_extclk_swrst);
			CTOP_CTRL_M14_Wr01(ctr27_extclk_swrst, reg_swrst_cve27, 0x0);
			CTOP_CTRL_M14_Wr01(ctr27_extclk_swrst, reg_swrst_cve54, 0x0);
			CTOP_CTRL_M14_WrFL(ctr27_extclk_swrst);
#endif
#endif
		}
