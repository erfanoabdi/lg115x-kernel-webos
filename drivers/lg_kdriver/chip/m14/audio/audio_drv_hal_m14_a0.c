...
#ifdef DSP_FIRMWARE_H13_ONLY_USED
#ifdef USE_M14_A0_AUDIO_DSP_FIRMWARE
#include "../../h13/audio/firmware/multi_codec_h13.h"			// audio decoder & encoder for DSP0
#include "../../h13/audio/firmware/multi_se_codec_h13.h" 		// audio post processing & se(sound engine) codec for DSP1
#endif	//#ifdef USE_M14_A0_AUDIO_DSP_FIRMWARE
#else
#ifdef USE_M14_A0_AUDIO_DSP_FIRMWARE
#ifndef IC_CERTIFICATION
#include "firmware/multi_codec_m14_a0.h"			// audio decoder & encoder for DSP0
#else
#include "firmware/multi_codec_m14_a0_certi.h"		// audio decoder & encoder for DSP0
#endif
#include "firmware/multi_se_codec_m14_a0.h" 		// audio post processing & se(sound engine) codec for DSP1
#endif	//#ifdef USE_M14_A0_AUDIO_DSP_FIRMWARE
#endif	//#ifdef DSP_FIRMWARE_H13_ONLY_USED
...
BOOLEAN M14_A0_AUDIO_CheckResetStatus ( UINT8 ui8ResetFlag )
{
	...
	if(ui8ResetFlag == AUD_OPTION_DSP1)
	{
...
#ifdef NOT_MEMMORY_OPTIMIZE
	AUD_M14_A0_Wr(aud_dsp0offset5, pstMemCfgAud->fw0_memory_base);
...
#ifdef NOT_MEMMORY_OPTIMIZE
	AUD_M14_A0_Wr(aud_dsp1offset5, pstMemCfgAud->fw1_memory_base);
...
/**
 * Copy a DSP1 codec firmware from memory.
 * Clear a DSP1 version registers.
 * @see
*/
SINT32 M14_A0_AUDIO_CopyDSP1Codec ( void )
{
#ifdef USE_M14_A0_AUDIO_DSP_FIRMWARE
	...
	ui32CodecSize = sizeof(se_codec_m14_a0);
	pui32Codec	  = (UINT32 *)se_codec_m14_a0;
	strcpy(codecName, "se_codec_m14_a0");
#endif
#ifdef NOT_MEMMORY_OPTIMIZE
...
#endif
	AUD_KDRV_DEBUG("M14_A0_AUDIO_CopyDSP1Codec : Started... Codec(%s), Size(%d)\n", codecName, ui32CodecSize);
	...
	if(g_AudKdrv.CopyDSP1 == TRUE)
	{
		...
		AUD_KDRV_PRINT("M14_A0_AUDIO_CopyDSP1Codec : Done(%s)!!!\n", codecName );
	}

	AUD_KDRV_DEBUG_TMP("M14_A0_AUDIO_CopyDSP1Codec : Done(%s)!!!\n", codecName);
	return RET_OK;
#else
	AUD_KDRV_ERROR("M14_A0_AUDIO_CopyDSP1Codec : DSP1 Firmware is not linked!!!\n");
	return RET_OK;
#endif
}
...
/**
 * Copy a DSP0 codec firmware.
 * @see
*/
SINT32 M14_A0_AUDIO_CopyDSP0Codec ( void )
{
#ifdef USE_M14_A0_AUDIO_DSP_FIRMWARE
...
#else
	//Set audio codec firmware image
	ui32CodecSize = sizeof(multi_codec_m14_a0);
	pui32Codec	  = (UINT32 *)multi_codec_m14_a0;
	strcpy(codecName, "multi_codec_m14_a0");
#endif
#ifdef NOT_MEMMORY_OPTIMIZE
	if(ui32CodecSize > pstMemCfgAud->fw0_memory_size)
	{
		AUD_KDRV_ERROR("M14_A0_AUDIO_CopyDSP0Codec : %s size is bigger than memory.(%d > %d)\n",	\
...
#endif
	AUD_KDRV_DEBUG("M14_A0_AUDIO_CopyDSP0Codec : Started... Codec(%s), Size(%d)\n", codecName, ui32CodecSize);
	...
	if(g_AudKdrv.CopyDSP0 == TRUE)
	{
		...
		AUD_KDRV_PRINT("M14_A0_AUDIO_CopyDSP0Codec : Done(%s)!!!\n", codecName );
	}

	AUD_KDRV_DEBUG_TMP("M14_A0_AUDIO_CopyDSP0Codec : Done(%s)!!!\n", codecName);
	return RET_OK;
#else
	AUD_KDRV_ERROR("M14_A0_AUDIO_CopyDSP0Codec : DSP0 Firmware is not linked!!!\n");
	return RET_OK;
#endif	//#ifdef USE_M14_A0_AUDIO_DSP_FIRMWARE
}
