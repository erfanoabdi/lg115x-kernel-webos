 ...
 * AUDIO device
 *
 * USE_XXX_AUDIO_DSP_FIRMWARE
 * -- The define of audio firmware to use current platform.
 *
 ----------------------------------------------------------------------------------------*/
#undef  USE_H13_AUDIO_DSP_FIRMWARE
#undef  USE_M14_A0_AUDIO_DSP_FIRMWARE
#define USE_H14_A0_AUDIO_DSP_FIRMWARE
