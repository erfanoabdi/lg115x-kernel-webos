...
#define NUM_OF_CODEC_AC3_INFO					2
...
#define AUD_DEC_IOR_GET_DELAY					_IOR(AUD_DEC_IOC_MAGIC, 16, UINT32)
 ...
 *
*/
typedef struct LX_AUD_DECODER_HEAAC_ES_INFO{
 ...
 *
*/
typedef struct LX_AUD_DECODER_MPEG_ES_INFO{
 ...
 *
*/
typedef struct LX_AUD_DECODER_AC3_ES_INFO{
	UINT8 bitRate;													///< Bit rate(Value is divide by 1000.(Value/KBps))
	UINT8 sampleRate;												///< Sampling rate((Value is divide by 1000.(Value/KHz))
	UINT8 channelNum;												///< Refer LX_ADEC_AUDIO_MODE_T
...
*/
typedef struct LX_AUD_DECODER_ES_INFO{
 ...
 * @see AUD_IOR_GET_ES_INFO
*/
typedef struct LX_AUD_DECODED_INFO{
