...
//audio related
#define HDMI_IOR_GET_AUDIO_INFO				_IOR(HDMI_IOC_MAGIC,  50, LX_HDMI_AUDIO_INFO_T)
#define HDMI_IOR_GET_COPY_INFO				_IOR(HDMI_IOC_MAGIC,  51, LX_HDMI_AUDIO_COPY_T)
...
#define HDMI_IOR_DEBUG_GET_AUDIO_INFO		_IOR(HDMI_IOC_MAGIC,  54, LX_HDMI_DEBUG_AUDIO_INFO_T)
...
typedef  enum
{
	...
	LX_HDMI_AUDIO_AC3_IEC60958	= 11,		///< AC3 Type, IEC60958 Format
...
typedef  enum
{
	...
	HDMI_STATE_CHECK_AVI_NO,
	HDMI_STATE_CHECK_AVI_CHG,
	HDMI_STATE_INTE_CHECK,
	HDMI_STATE_CHECK_MODE,
	HDMI_STATE_READ,
	HDMI_STATE_STABLE,
	HDMI_STATE_MAX,
} LX_HDMI_STATE_T;
...
/**
 * HDMI Info Frame Type.
 * HDMI Info FrameAudio type is defined.
 */
...
typedef struct HDMI_PHY_INFORM {
	...
	UINT32	tmds_clock;				// Phy TMDS Clock
...
typedef struct LX_HDMI_DRIVER_STATUS {
	LX_HDMI_TIMING_INFO_T PrevTiming;
	UINT32 TimingReadCnt;
	UINT32 HDMIState;
	LX_HDMI_AVI_COLORSPACE_T	PrevPixelEncoding;
	LX_HDMI_INFO_PACKET_T PrevAVIPacket;
	LX_HDMI_INFO_PACKET_T PrevVSIPacket;
	BOOLEAN AVIReadState;
	BOOLEAN VSIState 	;
	BOOLEAN AVIChangeState;
	BOOLEAN PortSelected;
	UINT32 MHLContentOff;

	BOOLEAN AudioMuteState;
	BOOLEAN AudioArcStatus;
	UINT32  IntrAudioState;
	UINT32  HdmiPortStableCount;
	UINT32  HdmiFreqErrorCount;
	UINT32  HdmiAudioThreadCount;
	UINT64  IntrBurstInfoCount;
	UINT64  TaskBurstInfoCount;
	LX_HDMI_AUDIO_INFO_T HdmiAudioInfo;

	UINT32 Intr_vf_stable;
	UINT32 Intr_avi;
	UINT32 Intr_src_mute;
	UINT32 Intr_vsi;
	...
	int CHG_AVI_count_MHL;
	int CHG_AVI_count_EQ;
	int TMDS_ERROR_EQ;
