...
typedef enum
{
	...
	LX_AUD_DAMP_FOR_GCD		= 0x10,		///< D-AMP Contol for GCD volume contol
} LX_AUD_DAC_MODE_T;
...
typedef enum {
	...
	LX_AUD_CODEC_DTS_M6,			///< 16
	LX_AUD_CODEC_AAC_BYPASS,		///< 17 Virtual Codec Name
	LX_AUD_CODEC_AC3_IEC60958,		///< 18(AC3 HDMI, IEC60958), Virtual Codec Name
 ...
 *
 */
typedef struct LX_AUD_EVENT_TYPE{
...
*/
typedef struct LX_AUD_OUTPUT_PORT_MUTE{
...
typedef struct {
	...
	UINT32					ui32Index;						// audio ES index
	UINT32					ui32Error;						// audio ES error
	UINT32					ui32discontinuity;				// audio ES discontinuity
	UINT32					ui32reserved[2];				// reserved
} LX_AUD_AU_INFO_T;
...
*/
typedef struct LX_AUD_REG_INFO{
...
*/
typedef struct LX_AUD_CUSTOM_IMC{
 ...
 */
 typedef struct LX_AUD_DEBUG_CTRL{
  ...
  * @see AUD_IOW_DEBUG_PRINT_CTRL
 */
 typedef struct LX_AUD_DEBUG_MEM_DUMP{
...
typedef struct LX_AUD_FW_DEBUG_INFO{
	UINT32				num_of_index;
	UINT32				mask_value;
 ...
 * @see .
*/
typedef struct LX_AUD_DEBUG_DECODED_INFO{
