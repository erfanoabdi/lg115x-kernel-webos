...
#define AUD_MASTER_IOW_SET_POWER_CTRL					_IOW(AUD_MASTER_IOC_MAGIC,  9, LX_AUD_MASTER_CONFIG_POWER_CTRL_T)

#define AUD_MASTER_IOW_SET_SPK_OUTPUT					_IOW(AUD_MASTER_IOC_MAGIC, 10, LX_AUD_MASTER_SPK_OUTPUT_T)
#define AUD_MASTER_IOW_SET_MIXER_DELAY					_IOW(AUD_MASTER_IOC_MAGIC, 11, LX_AUD_MASTER_CONFIG_MIXER_DELAY_T)
...
#define AUD_IOW_SET_INPUT_DELAY							_IOW(AUD_MASTER_IOC_MAGIC, 75, LX_AUD_SET_INPUT_DELAY_T)
...
#define AUD_IOW_CUSTOM_IMC								_IOW(AUD_MASTER_IOC_MAGIC,  191, LX_AUD_CUSTOM_IMC_T)
...
#define AUD_IOWR_DEBUG_GET_DECODED_INFO					_IOWR(AUD_MASTER_IOC_MAGIC,	199, LX_AUD_DEBUG_DECODED_INFO_T)
...
typedef enum {
	...
	LX_AUD_MASTER_SE_FN_005				=	5,			///< HARM
	...
	LX_AUD_MASTER_SE_FN_SET				=	20,			///< mode to set functions
	LX_AUD_MASTER_SE_FN_UPDATE_PARAM	=	30,			///< mode to update setted parameters for reset
