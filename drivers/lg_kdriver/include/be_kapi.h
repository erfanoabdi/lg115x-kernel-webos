...
#define BE_IOW_TOP_FIRMWARE_DEBUG		_IOW(BE_IOC_MAGIC, 17, BE_FIRMWARE_DEBUG_T)
#define BE_IOW_SET_UART_FOR_MCU			_IOW(BE_IOC_MAGIC, 18, BOOLEAN )
...
#define BE_IOR_GET_FIRMWARE_INFO_ADDR	_IOR(BE_IOC_MAGIC, 21, BE_FIRMWARE_INFO_T )
#define BE_IOR_GET_GIT_DATE_INFO        _IO(BE_IOC_MAGIC, 22)
#define BE_IOR_GET_BE_KERNEL_DRV_INFO	_IOR(BE_IOC_MAGIC, 23, LX_BE_KDRV_INFO_T)
...
typedef struct
{
	UINT32	u32PictureMode;			// 0:BT709, 1:SMPTE, 2:EBU, 3:Color Extension
} LX_BE_WCG_MODE_T;
