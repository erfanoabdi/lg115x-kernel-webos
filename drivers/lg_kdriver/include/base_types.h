...
#define LX_CHIP_M15						0x16	/* M15=        */
#define LX_CHIP_H15						0x17	/* H15=        */ 
...
#define	LX_COMP_CHIP(val,chp)			( (int)((val)&0xff00) - (int)((chp<<8) & 0xff00) )	/* compare if current value is chip (L8,L9,H13 etc) 0 if same chip */
#define	LX_COMP_CHIP_REV(val,chprev)	( (int)((val)&0xffff) - (int)((chprev) & 0xffff) )	/* compare if current value is chip (L9A0,H13B0 etc) 0 if same chip */
