...
typedef enum {
	...
	LX_DE_WIN_2,
	LX_DE_WIN_MAX	 = LX_DE_WIN_2,	///< max number
}
LX_DE_WIN_ID_T;
...
typedef struct
{
	...
	UINT32						enable;	///< enable control [rw]
	...
	LX_DE_RECT_T				srcSize;	///< source size infomation
	LX_DE_RECT_T				winSize;	///< window size infomation	
